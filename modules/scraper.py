...
class hotel_scraper(object):
    ...
    def get_datadir(self):
        home_dir = '/Users/rong/Documents/Python/Web Scraping/Coding Example/hotel reviews/'
    ...
    def hotel_data(self):
        ...
        if os.path.isfile(data_dir + 'hotel.csv'):
            ...
            df.to_csv(self.get_datadir() + 'hotel.csv', index=False)
    ...
    def get_reviews(self):
        ...
        df = self.load_csv(data_dir + 'hotel.csv')
        link_list = df['Link']
        hotel_list = df['Name']
    ...
    def load_reviews(self):
        review_dir = self.get_datadir() + 'reviews/'
    ...
    def gen_review_data(self):
        data_dir = self.get_datadir()
        if os.path.isfile(data_dir + 'review_data.csv'):
            print('Review Data Exists!')
        else:
            file = data_dir + 'hotel.csv'
            ...
            finalDF.to_csv(self.get_datadir() + 'review_data.csv', index=False)
